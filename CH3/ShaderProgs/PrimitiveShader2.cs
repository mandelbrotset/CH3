...
namespace CH3.Shaders
{
    public class PrimitiveShader2
    {
        ...
        public PrimitiveShader2() {
            uint tmp_program_id;
            using (StreamReader vs = new StreamReader("../../shaders/primitiveVert.vert")) 
            using (StreamReader fs = new StreamReader("../../shaders/primitiveFrag.frag")) 
        ...
        public void UnUseProgram()
        {
            ...
            GL.DisableVertexAttribArray(vertexPositionIndex);
            GL.DisableVertexAttribArray(vertexTexCoordIndex);
            GL.DisableVertexAttribArray(vertexNormalIndex);
            GL.UseProgram(0);
        }
